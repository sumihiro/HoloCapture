...
- (void)login {
    ...
    [client login:^{
        ...
        [self save];
        [self performSegueWithIdentifier:@"streaming" sender:nil];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([segue.identifier isEqualToString:@"streaming"]) {
        StreamingViewController *vc = (StreamingViewController*)segue.destinationViewController;
